...
# a 700-parameter sentence-embeddings NLP model trained on Pubmed biomedical data
# https://github.com/ncbi-nlp/BioSentVec/wiki
model = fasttext.load_model('/Users/michael/fintech/group_project_1/group-project-1/BioSentVec_PubMed_MIMICIII-bigram_d700.bin')
...
if __name__ == "__main__":
    for symbol, blurb in company_profiles.items():
        print(symbol)
        print(nlp(blurb))